...
- [Chapter 2: Measure value: The foundations of product analytics](#chapter-2-measure-value-the-foundations-of-product-analytics)
  ...
  - [How can I monetize my product](#how-can-i-monetize-my-product)
    - [Measuring product value](#measuring-product-value)
...
- [Chapter 3: Get to know your users](#chapter-3-get-to-know-your-users)
  ...
  - [What’s DAU/ WAU/ MAU?](#whats-dau-wau-mau)
    - [Defining active usage](#defining-active-usage)
  - [When should I measure DAU/WAU/MAU?](#when-should-i-measure-dauwaumau)
    - [✅ DAU/WAU/MAU as one of the ways to assess overall business health](#-dauwaumau-as-one-of-the-ways-to-assess-overall-business-health)
    - [✅ DAU/WAU/MAU to track seasonal changes for your business](#-dauwaumau-to-track-seasonal-changes-for-your-business)
    - [✅ DAU/WAU/MAU to measure marketing funnel effectiveness](#-dauwaumau-to-measure-marketing-funnel-effectiveness)
    - [❌ DAU/WAU/MAU for product benchmarking](#-dauwaumau-for-product-benchmarking)
    - [❌ DAU/WAU/MAU for building better products](#-dauwaumau-for-building-better-products)
...
- [Chapter 5: retain your users](#chapter-5-retain-your-users)
  - [Where are my users dropping off?](#where-are-my-users-dropping-off)
    - [Big drop-off points](#big-drop-off-points)
  ...
  - [How can I measure user drop off?](#how-can-i-measure-user-drop-off)
    - [Setup Funnels](#setup-funnels)
  - [Why should I measure retention?](#why-should-i-measure-retention)
    - [mistakes when defining retention metrics.](#mistakes-when-defining-retention-metrics)
